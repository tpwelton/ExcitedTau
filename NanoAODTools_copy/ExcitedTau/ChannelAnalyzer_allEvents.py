...
#         self.out.fillBranch("lep0_vis_pt",-1)
#         self.out.fillBranch("lep0_vis_eta",-1)
#         self.out.fillBranch("lep0_vis_phi",-1)
#         self.out.fillBranch("lep0_vis_mass",-1)
#         self.out.fillBranch("lep1_vis_pt",-1)
#         self.out.fillBranch("lep1_vis_eta",-1)
#         self.out.fillBranch("lep1_vis_phi",-1)
#         self.out.fillBranch("lep1_vis_mass",-1)
#         self.out.fillBranch("ll_vis_pt",-1)
#         self.out.fillBranch("ll_vis_mass",-1)
#         self.out.fillBranch("ll_vis_dr",-1)
#         self.out.fillBranch("lep0_col_pt",-1)
#         self.out.fillBranch("lep0_col_eta",-1)
#         self.out.fillBranch("lep0_col_phi",-1)
#         self.out.fillBranch("lep0_col_mass",-1)
#         self.out.fillBranch("lep1_col_pt",-1)
#         self.out.fillBranch("lep1_col_eta",-1)
#         self.out.fillBranch("lep1_col_phi",-1)
#         self.out.fillBranch("lep1_col_mass",-1)
#         self.out.fillBranch("ll_col_mass",-1)
#         self.out.fillBranch("ll_col_pt",-1)
#         self.out.fillBranch("ll_col_dr",-1)
        if len(goodPhotons) > 0:
...
#       else: 
#         self.out.fillBranch("photon_pt",-1)
#         self.out.fillBranch("photon_eta",-1)
#         self.out.fillBranch("photon_phi",-1)
#         self.out.fillBranch("gamlep0_vis_mass",-1)
#         self.out.fillBranch("gamlep0_vis_dr",-1)
#         self.out.fillBranch("gamlep1_vis_mass",-1)
#         self.out.fillBranch("gamlep1_vis_dr",-1)
#         self.out.fillBranch("gamlep0_col_mass",-1)
#         self.out.fillBranch("gamlep0_col_dr",-1)
#         self.out.fillBranch("gamlep1_col_mass",-1)
#         self.out.fillBranch("gamlep1_col_dr",-1)

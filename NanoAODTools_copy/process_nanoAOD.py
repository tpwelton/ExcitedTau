...
#f = open("../../../ExcitedTau/Processed_NanoAOD/Taustar_TauG_L1000_m1000_13TeV_pythia8_NanoAOD.txt")
#f = open("../../../ExcitedTau/Processed_NanoAOD/Taustar_TauG_L250_m250_f0p1_fprime0p1_13TeV_pythia8_NanoAOD.txt")
f = open("../../../ExcitedTau/Processed_NanoAOD/Taustar_TauG_L1000_m1000_f1_fprime0p1_13TeV_pythia8_NanoAOD.txt")
xrd_prefix = "root://cms-xrd-global.cern.ch/"
outdir = "Taustar_TauG_L1000_m1000_f1_fprime0p1_13TeV_pythia8_NanoAOD/"
files = f.readlines()
f.close()
...
#files = ["root://cmseos.fnal.gov//store/user/twelton/Taustar_TauG_L250_m250_13TeV_pythia8/Taustar_TauG_L250_m250_13TeV_pythia8/Taustar_TauG_L250_m250_13TeV_pythia8_NanoAOD/210412_184753/0000/Taustar_TauG_L250_m250_13TeV_pythia8_NanoAOD_1.root"]
...
#      cmd = "python scripts/nano_postproc.py ../../../ExcitedTau/Processed_NanoAOD ../../../ExcitedTau/EmbeddedSamples_NanoAOD/TauTau2018D/" + fileName.strip() + " -I " + modLoc + mod + " -s _chan" + str(num)
      cmd = "python scripts/nano_postproc.py ../../../ExcitedTau/Processed_NanoAOD/" +outdir + " " + xrd_prefix + fileName.strip() + " -I " + modLoc + mod + " -s _chan" + str(num)
#      cmd = cmd + "_ditau"
#      cmd = cmd + "_allCuts"
#      cmd = cmd + "_phiCheck"
#      cmd = cmd + "_2taus"

...
files=["Taustar_TauG_L10000_m1000_13TeV_pythia8_NanoAOD_chan0_allCuts.root"]
#files=["test_1_chan0_allCuts.root"]

p=PostProcessor(".",files,cut=preselection,branchsel=None,modules=[HistMaker()],noOut=True,histFileName="MuTauSignal1000_photon100_hists_slim.root",histDirName="plots",maxEntries=None)
p.run()
